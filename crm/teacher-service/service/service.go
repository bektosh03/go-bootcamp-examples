...
func (s Service) ListTeachers(ctx context.Context, page, limit int32) ([]teacher.Teacher, error) {
	teachers, err := s.repo.ListTeachers(ctx, page, limit)
	if err != nil {
		return nil, err
	}
...
func (s Service) ListSubjects(ctx context.Context, page, limit int32) ([]subject.Subject, error) {
	subjects, err := s.repo.ListSubjects(ctx, page, limit)
	if err != nil {
		return nil, err
	}
